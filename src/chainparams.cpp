...
public:
    CMainParams() {
        ...
        consensus.nHardForkRuleChangeActivationThreshold = 1996; // 99% of 2016
        ...
        // Deployment of PlusPlus (BIP++1)
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].bit = 27;
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].nStartTime = 1665575400; // October 12th, 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].min_activation_height = 0; // No activation delay
...
public:
    CTestNetParams() {
        ...
        // Deployment of PlusPlus (BIP++1)
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].bit = 27;
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].nStartTime = Consensus::BIP9Deployment::ALWAYS_ACTIVE;
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;
        consensus.vDeployments[Consensus::DEPLOYMENT_PLUSPLUS].min_activation_height = 0; // No activation delay
